...
import { getItem, getList } from '../store/actions/newsActions';
...
class News extends React.Component<interfaceProps, {}> {
  ...
  render() {
    return (
    <div>
      <span onClick={()=>{this.props.getItem();console.log(this.props)}}>{this.props.newsState.title}</span>
      <span onClick={()=>{this.props.getList(1,5);console.log(this.props)}}>{this.props.newsState.content}</span>
    <span>
